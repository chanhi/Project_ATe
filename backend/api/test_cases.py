...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  확장된 생성 요청 (requested_count 추가)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

class TestCaseGenerateRequestV2(BaseModel):
    """v2: 사용자가 원하는 케이스 개수를 지정 가능"""
    project_id: str
    ...
    requested_count: int = Field(
        default=5,
        ge=1, le=5,
        description="생성할 테스트 케이스 개수 (1~5)",
    )
...
async def generate_test_cases(request: TestCaseGenerateRequestV2):
    """
    자연어 또는 기획서 한 번의 입력으로 여러 테스트 케이스를 한 번에 생성.

    - 한 번의 AI 호출로 requested_count(1~5)개 케이스 생성
    - AI가 일부만 생성하면 사용자에게 알림 표시
    """
    ...
    if request.document_id:
        ...
        if not source_text:
            raise HTTPException(
                status_code=400,
                detail="문서의 extracted_text가 비어있습니다.",
            )
    ...
    return APIResponse(
        ...
        message=f"{request.requested_count}개 케이스 생성 요청 등록됨. AI가 처리 후 결과가 채워집니다.",
    )
