...
from core.mongo import get_test_cases_collection, get_test_runs_collection
...
async def execute_batch(request: TestCaseBatchRunRequest):
    ...
    return APIResponse(
        ...
        message=f"{len(triggered)}개 실행, {len(skipped)}개 스킵",
    )
